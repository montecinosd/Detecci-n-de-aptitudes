...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Imagen', models.ImageField(blank=True, null=True, upload_to=declarar_SVA.models.content_file_name)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Aptitud_vinculada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Aptitudes')),
            ],
        ),
        migrations.CreateModel(
            name='Direccion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Direccion', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Direccion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Aptitud_vinculada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Aptitudes')),
                ('Cuestionario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Cuestionario')),
            ],
        ),
        migrations.CreateModel(
            name='Respuestas',
        ...
        migrations.AddField(
            model_name='pregunta',
            name='Respuestas',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Respuestas'),
        ),
        migrations.AddField(
            model_name='pregunta',
            name='Usuario',
        ...
        migrations.AddField(
            ...
            name='Area',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Areas'),
        ),
        migrations.AddField(
            model_name='aptitudes',
            name='Usuario',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Aptitudes'),
        ),
        migrations.AddField(
            model_name='aptitude_validadas',
            name='Usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='declarar_SVA.Persona'),
        ),
    ]
